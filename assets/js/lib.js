...
((w, d, h = d.documentElement, noop = () => { }, tmp = 0, Reflect = w.Reflect) => {
    ...
    w.isElementInViewport = (dom, r = dom.getBoundingClientRect()) => {
        return r.top >= 0 && r.left >= 0 && r.bottom <= w.getViewport().h && r.right <= w.getViewport().w
    }
    ...
    w.xmlToJSON = (xml, opt) => {
        ...
        const options = {
            ...
            /* # extract cdata and merge with text */
                ...
                /* # enable namespaces and access the nskey property */
            ...
            normalize = () => {
                if (sCollectedTxt) {
                    if (options.grokText) {
                        ...
                        vResult[options.textKey] = tmp !== null && typeof tmp !== 'undefined'
                            ? tmp
        ...
        const cmd = {
                ...
                'embed': (d, j) => {
                    ...
                    w.on(d, 'click', (e) => {
                        ...
                        d.parentNode.replaceChild(w.stringToDOM(`<span class='${className}'>
